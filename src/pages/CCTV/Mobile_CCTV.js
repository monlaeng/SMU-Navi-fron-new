...
const Mobile_CCTV = () =>  {
    ...
    function selectBtn(idx) {
        if(idx === "m-cctv1"){
            ...
            document.getElementById('m-myIframe').src = "http://www.utic.go.kr/view/map/cctvStream.jsp?cctvid=L010169&cctvname=%25EC%258B%259C%25EC%25B2%25AD&kind=Seoul&cctvip=null&cctvch=51&id=60&cctvpasswd=null&cctvport=null&minX=126.86761300167508&minY=37.52331181092342&maxX=127.08748873586144&maxY=37.60874703165121";
        }
    }
